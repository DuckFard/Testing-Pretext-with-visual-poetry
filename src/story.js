export const STORY_PARAGRAPHS = Object.freeze([
...
const chapter = (title, eyebrow, paragraphIndexes, companions, rainLevel, pullquote, kanji = "") =>
  Object.freeze({
    title,
    eyebrow,
    paragraphs: Object.freeze(paragraphIndexes.map((index) => STORY_PARAGRAPHS[index])),
...
export function getChapter(index) {
  return CHAPTERS[getChapterIndex(index)];
}
